...
mql_test_cases = [
    ...
    pytest.param(
        'apdex(sum(`d:transactions/duration@millisecond`) / sum(`d:transactions/duration@millisecond`), 500){dist:["dist1", "dist2"]}',
        {
            "entity": "generic_metrics_distributions",
            "start": "2021-01-01T00:00:00",
            "end": "2021-01-02T00:00:00",
        ...
        "generic_metrics",
        id="Select metric with arbitrary function in formula",
    ),
]
