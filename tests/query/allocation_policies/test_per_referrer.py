...
class TestPerReferrerPolicy:
    ...
    def test_policy_pass_basic(self):
        ...
        with override_component_config(policy, "default_concurrent_request_per_referrer", 2):
    ...
    def test_throttle(self) -> None:
        ...
        with override_component_configs(
            (policy, "default_concurrent_request_per_referrer", 4),
            (policy, "requests_throttle_divider", 2),
            (policy, "threads_throttle_divider", 2),
        ):
