...
class TestUtil(BaseTest):
    ...
    def test_conditions_expr(self, dataset):
        ...
        assert conditions_expr(dataset, conditions, {}, ParsingContext()) == 'notEmpty(arrayElement(exception_stacks.type, 1)) = 1'
        ...
        assert conditions_expr(dataset, conditions, {}, ParsingContext()) == 'arrayExists(x -> assumeNotNull(x LIKE \'%foo%\'), exception_frames.filename)'
        ...
        assert conditions_expr(dataset, conditions, {}, ParsingContext()) == 'arrayAll(x -> assumeNotNull(x NOT LIKE \'%foo%\'), exception_frames.filename)'
