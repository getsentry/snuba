...
class TestUtil(BaseTest):
    ...
    def test_column_expr(self):
        ...
        assert column_expr(self.dataset, None, body.copy(), alias='sum', aggregate='sum') ==\
    ...
    def test_complex_conditions_expr(self):
        ...
        assert complex_column_expr(self.dataset, tuplify(['topK', [3], ['project_id']]), body.copy()) == 'topK(3)(project_id)'
        assert complex_column_expr(self.dataset, tuplify(['topK', [3], ['project_id'], 'baz']), body.copy()) == '(topK(3)(project_id) AS baz)'
