...
def test_rollout() -> None:
    ...
    assert run_new_pipeline("events", past) is False
    assert run_new_pipeline("events", future) is False
    assert run_legacy_pipeline("events", past) is True
    assert run_legacy_pipeline("events", future) is True
    ...
    assert run_new_pipeline("events", past) is True
    assert run_new_pipeline("events", future) is True
    assert run_legacy_pipeline("events", past) is False
    assert run_legacy_pipeline("events", future) is False
