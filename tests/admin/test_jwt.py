...
def test_validate_assertion_success(mock_settings, mock_certs, key_pair):
...
def test_validate_assertion_invalid_signature(mock_settings, mock_certs):
...
def test_validate_assertion_expired(mock_settings, mock_certs, key_pair):
...
def test_validate_assertion_invalid_audience(mock_settings, mock_certs, key_pair):
...
def test_validate_assertion_missing_email(mock_settings, mock_certs, key_pair):
...
def test_validate_assertion_missing_sub(mock_settings, mock_certs, key_pair):
