...
tests = [
    ...
    AttributeKey(name="sentry.organization_id", type=AttributeKey.Type.TYPE_INT),
    AttributeKey(name="sentry.project_id", type=AttributeKey.Type.TYPE_INT),
    AttributeKey(name="kyles_attr", type=AttributeKey.Type.TYPE_STRING),
]
