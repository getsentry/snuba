...
from snuba.datasets.events_processor_base import ReplacementTypes
...
class TestReplacer:
    ...
    def test_tombstone_events_process(self, old_primary_hash) -> None:
        ...
        message = (2, ReplacementTypes.TOMBSTONE_EVENTS, message_kwargs)
    ...
    def test_unmerge_hierarchical_process(self) -> None:
        ...
        message = (
            2,
            ReplacementTypes.END_UNMERGE_HIERARCHICAL,
            {
                "project_id": self.project_id,
                "previous_group_id": 1,
                "new_group_id": 2,
