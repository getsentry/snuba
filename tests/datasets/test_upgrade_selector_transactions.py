...
def test_selector_function(
    ...
    set_config("rollout_upgraded_transactions_trust", trust_secondary)
    set_config("rollout_upgraded_transactions_execute", exec_both)

    previous_time = settings.TRANSACTIONS_UPGRADE_BEGINING_OF_TIME
    settings.TRANSACTIONS_UPGRADE_BEGINING_OF_TIME = beginning_of_time
