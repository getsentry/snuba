...
class TestKafkaConfig(TestCase):
    ...
    def test_default_config_legacy_override_default_servers(self):
        default_broker = "my.broker:9092"
        settings.DEFAULT_BROKERS = [default_broker]
        broker_config = get_default_kafka_configuration()
        self.assertEqual(broker_config["bootstrap.servers"], default_broker)

        default_brokers = ["my.broker:9092", "my.second.broker:9092"]
        settings.DEFAULT_BROKERS = default_brokers
        broker_config = get_default_kafka_configuration()
        self.assertEqual(broker_config["bootstrap.servers"], ",".join(default_brokers))

    def test_default_config_legacy_override_storage_servers(self):
    ...
    def test_default_config_legacy_override_storage_servers_fallback(self):
    ...
    def test_default_config_override_new_config(self):
        default_broker = "my.broker:9092"
    ...
    def test_default_config_override_new_config_storage(self):
        default_broker = "my.other.broker:9092"
        default_broker_config = {
            "bootstrap.servers": default_broker,
        }
        ...
        self.assertEqual(broker_config["bootstrap.servers"], other_broker)

    def test_default_config_new_fallback_old(self):
        ...
        broker_config = get_default_kafka_configuration(StorageKey.ERRORS)
        self.assertEqual(broker_config["bootstrap.servers"], old_default_broker)

    def test_default_config_new_fallback_old_storage(self):
        old_default_broker = "my.broker:9092"
        default_broker = "my.other.broker:9092"
        default_broker_config = {
            "bootstrap.servers": default_broker,
