...
&& /devinfra/scripts/k8s/k8s-deploy.py \
  ...
  --container-name="rust-generic-metrics-counters-consumer" \
  --container-name="rust-generic-metrics-distributions-consumer" \
  --container-name="rust-generic-metrics-gauges-consumer" \
  --container-name="rust-generic-metrics-sets-consumer" \
