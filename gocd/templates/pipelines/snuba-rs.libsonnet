...
function(region) {
  ...
  materials: {
    snuba_repo: {
      ...
      branch: 'master',
      destination: 'snuba',
      // GoCD ignore filters do not support negated patterns, so list the
      // current snuba paths outside cli, datasets/configuration, and settings.
      ignore: [
        'snuba/*',
        'snuba/admin/**/*',
        'snuba/attribution/**/*',
        ...
        'snuba/datasets/*',
        'snuba/datasets/cdc/**/*',
        'snuba/datasets/common/**/*',
        'snuba/datasets/entities/**/*',
        'snuba/datasets/entity_subscriptions/**/*',
        'snuba/datasets/plans/**/*',
        'snuba/datasets/processors/**/*',
        'snuba/datasets/schemas/**/*',
        'snuba/datasets/storages/**/*',
        'snuba/env/**/*',
        'snuba/lw_deletions/**/*',
        'snuba/manual_jobs/**/*',
        'snuba/migrations/**/*',
