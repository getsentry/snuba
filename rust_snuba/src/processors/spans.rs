...
struct FromSpanMessage {
    ...
    duration_ms: u32,
    end_timestamp_micro: Option<f64>,
    ...
    span_id: String,
    start_timestamp_micro: Option<f64>,
...
impl TryFrom<FromSpanMessage> for Span {
    ...
    fn try_from(from: FromSpanMessage) -> anyhow::Result<Span> {
        ...
        Ok(Self {
            ...
            end_timestamp_micro: from.end_timestamp_micro.unwrap_or_default(),
            ...
            start_timestamp_micro: from.start_timestamp_micro.unwrap_or_default(),
...
mod tests {
    ...
    fn valid_span() -> TestSpanMessage {
        TestSpanMessage {
            ...
            end_timestamp_micro: Some(1715866674.111787),
            ...
            start_timestamp_micro: Some(1715866673.111787),
