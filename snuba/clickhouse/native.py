...
class ClickhouseResult:
    ...
    trace_output: str = ""
    # Server/driver-assigned id for this statement when known. clickhouse-connect
    # exposes it via QueryResult.query_id (summary or client-autogenerated).
    # The native driver only knows it when the caller passed one in.
    query_id: str = ""
