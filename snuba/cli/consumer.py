...
@click.option('--dead-letter-topic', default='dead-letter-events',
              help='Topic to produce events that could not be processed into.')
...
def consumer(raw_events_topic, replacements_topic, commit_log_topic, dead_letter_topic, consumer_group,
