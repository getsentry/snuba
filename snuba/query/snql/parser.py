...
def parse_snql_query_initial(
    ...
    try:
        ...
        logger.warning("Invalid SnQL query (%s)", e)
        raise e
...
def _post_process(
    ...
    for func in funcs:
        ...
        with traces.start_span(name=description, attributes={SENTRY_OP: "processor"}):
...
def parse_snql_query(
    ...
    with traces.start_span(name="parse_snql_query_initial", attributes={SENTRY_OP: "parser"}):
