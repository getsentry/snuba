...
conf_sets = load_storage_config(StorageKey.GENERIC_METRICS_SETS)

sets_storage = ReadableTableStorage(
    storage_key=StorageKey(conf_sets["storage"]["key"]),
    storage_set_key=StorageSetKey(conf_sets["storage"]["set_key"]),
    schema=TableSchema(
        columns=ColumnSet(parse_columns(conf_sets["schema"]["columns"])),
        local_table_name=conf_sets["schema"]["local_table_name"],
        dist_table_name=conf_sets["schema"]["dist_table_name"],
        storage_set_key=StorageSetKey(conf_sets["storage"]["set_key"]),
    ),
    query_processors=get_query_processors(conf_sets["query_processors"]),
)
...
distributions_storage = ReadableTableStorage(
    ...
    schema=TableSchema(
        ...
        local_table_name=conf_distributions["schema"]["local_table_name"],
        dist_table_name=conf_distributions["schema"]["dist_table_name"],
        storage_set_key=StorageSetKey(conf_distributions["storage"]["set_key"]),
    ),
