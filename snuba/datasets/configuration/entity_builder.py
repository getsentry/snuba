...
from snuba.datasets.configuration.utils import get_writable_storage, parse_columns
...
) -> Sequence[StorageAndMappers]:
    return [
        StorageAndMappers(
            get_storage(StorageKey(config_storage_and_mappers["storage"])),
