...
class TransactionsDataset(TimeSeriesDataset):
    def __init__(self) -> None:
        ...
        schema = ReplacingMergeTreeSchema(
            ...
            order_by_expr="(project_id, _finish_date, transaction_name, cityHash64(span_id))",
            order_by_cols={"project_id", "_finish_date", "transaction_name", "span_id"},
            partition_by="(retention_days, toMonday(_finish_date))",
            partition_by_cols={"retention_days", "_finish_date"},
