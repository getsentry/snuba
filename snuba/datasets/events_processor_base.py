...
class EventsProcessorBase(MessageProcessor, ABC):
    ...
    @abstractmethod
    def extract_custom(self, message, metadata=None):
        raise NotImplementedError

    @abstractmethod
    def extract_custom_post_tags(self, message, tags, metadata=None):
        raise NotImplementedError
    ...
    def extract_promoted_contexts(self, processed, contexts, tags):
        pass
    ...
    def process_insert(self, message, metadata=None):
        ...
        processed = {"deleted": 0}
        extract_project_id(processed, message)
        self._extract_event_id(processed, message)
        ...
        self.extract_custom(processed, message, data)
        ...
        self.extract_custom_post_tags(processed, message, tags, metadata)

        contexts = data.get("contexts", None) or {}
        self.extract_promoted_contexts(processed, contexts, tags)
        self.extract_custom_post_contexts(processed, message, contexts, metadata)
