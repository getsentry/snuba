...
CLICKHOUSE_MIGRATIONS_DDL_USER = os.environ.get(
    "CLICKHOUSE_MIGRATIONS_DDL_USER", "default"
)
CLICKHOUSE_MIGRATIONS_DDL_PASSWORD = os.environ.get(
    "CLICKHOUSE_MIGRATIONS_DDL_PASS", ""
)
