...
class Migration(migration.ClickhouseNodeMigration):
    blocking = False
    granularity = "8192"
    meta_view_name = "generic_metric_sets_meta_mv"
    meta_local_table_name = "generic_metric_sets_meta_local"
    meta_dist_table_name = "generic_metric_sets_meta_dist"
    ...
    tag_value_view_name = "generic_metric_sets_meta_tag_values_mv"
    tag_value_local_table_name = "generic_metric_sets_meta_tag_values_local"
    tag_value_dist_table_name = "generic_metric_sets_meta_tag_values_dist"
