...
class Migration(migration.ClickhouseNodeMigration):
    blocking = False
    granularity = "2048"
    local_table_name = "generic_metric_counters_local"
        ...
        return [
            operations.CreateTable(
                ...
                engine=table_engines.AggregatingMergeTree(
                    storage_set=self.storage_set_key,
                    order_by="(org_id, project_id, metric_id, granularity, timestamp, tags.key, tags.raw_value, retention_days, use_case_id)",
