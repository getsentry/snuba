...
import snuba.migrations.group_loader as group_loader
...
def generate_migration(oldstorage: str, newstorage: str) -> None:
    ...
    forwardops, backwardops = generate_migration_ops(old_stor_dict, new_stor_dict)
    migration = _ops_to_migration(forwardops, backwardops)
